...
export const metadata: Metadata = {
  title: "Login - My Jarvis Gua",
  description: "Login to your My Jarvis Gua account to access your personalized dashboard and manage your settings.",
  robots: {
    index: false,
  },
};
...
export default function LoginPage() {
  return (
    <div className="w-full sm:w-110 bg-background">
      {/* ── Card ──────────────────────────────────────────────────────────── */}
        ...
        <div className="text-center mb-8">
          ...
          <div className="inline-flex items-center justify-center mb-4">
            ...
            <Image
              ...
              priority
            />
            {/* Large screens: Login-FullBody.png */}
            <Image
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 text-muted-foreground">or login with</span>
            </div>
          </div>
